...
contract HelperConfig is CodeConstants, Script {
    ...
    function getMainnetConfig() public view returns (NetworkConfig memory) {
        return
            NetworkConfig({
                ...
                keepersRegistry: MAINNET_KEEPERS_REGISTRY,
    ...
    function getSepoliaConfig() public view returns (NetworkConfig memory) {
        return
            NetworkConfig({
                ...
                keepersRegistry: SEPOLIA_KEEPERS_REGISTRY,
     ...
     * @return address Chainlink Keepers Registry address
     */
    function getKeepersRegistry() public view returns (address) {
        return activeNetworkConfig.keepersRegistry;
    }
