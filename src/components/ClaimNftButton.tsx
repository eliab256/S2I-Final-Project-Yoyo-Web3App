            ...
            {showNoClaimPopup && (
                ...
                >
                    ...
                    >
                        ...
                        <h2 className="text-xl md:text-2xl font-semibold text-yellow-700 mb-2">No NFTs Available</h2>
                        <p className="text-yellow-600 mb-4">You don't have any unclaimed NFTs at the moment.</p>
                    </div>
                </div>
            )}
        </>
