...
const BidResume: React.FC<BidResumeProps> = ({ bidAmount }) => {
    ...
    useEffect(() => {
        ...
        if (userBalance <= bidPlacedInWei) {
            //imposta not enough balance true in redux
            dispatch(setInsufficientBalance());
        }

        if (higherBidder === address) {
            //imposta already higher bidder true in redux
                    ...
                    <>
                        ...
                        <div className="space-y-3 mb-6 px-12">
                            ...
                            <BidStatusCheck
                                ...
                                additionalInfo={
                                    hasUnclaimedTokens ? 'Please claim your tokens before placing a new bid' : undefined
                                }
                                icon={{ valid: '✅', invalid: '⚠️' }}
                                delay={1}
                            />
